...
return [
    ...
    */
    ...
    'footer' => '© Международна конференция "Технически университет Варна" 2016 ',
    ...
    'and' => 'и',
    'export' => 'Експорт',
    'auto' => 'Автоматично разпределяне на рецензенти',
    'are-you-sure' => 'Сигурни ли сте, че искате да разпределите рецензентите автоматично(ако вече са разпределени те ще се разпределят отново и текущото разпределение ще бъде изтрито!)?',
    'no-papers' => 'Все още нямате доклади',
    'separated' => 'разделени със запетая ,',
    'count' => 'брой',
];