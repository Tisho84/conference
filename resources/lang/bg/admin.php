...
return [
    ...
    'user-types' => 'Тип потребители',
    'add-user' => 'Добавяне нов потребител',
    'update-user' => 'Актуализация на потребител',
    'access' => 'Достъп',
    ...
    'evaluate' => 'Оценка',
    'add-template' => 'Добавяне на нов темплейт',
    'update-template' => 'Актуализация на темплейт',
];