    ...
    <div class="mt padding-5">
        ...
        <form class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10"><label class="control-label-right">{{ isset($paper->category) ? $paper->category->langs->first()->name : '' }}</label></div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10"><label class="control-label-right">{!! HTML::link(rawurlencode('archive/' . $archive->name . '/' . $paper->source), $paper->source) !!}</label></div>
            </div>
            ...
            @if ($paper->payment_source)
                <div class="form-group">
                    ...
                    <div class="col-sm-10"><label class="control-label-right">{!! HTML::link(rawurlencode('archive/' . $archive->name . '/' . $paper->payment_source), $paper->payment_source) !!}</label></div>
                </div>
            @endif
            <div class="form-group">
