    ...
    <div class="mt padding-5">
        ...
        <form class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10"><label class="control-label-right">{!! HTML::link('archive/' . $archive->name . '/' . rawurlencode($paper->source), $paper->source) !!}</label></div>
            </div>
            ...
            @if ($paper->payment_source)
                <div class="form-group">
                    ...
                    <div class="col-sm-10"><label class="control-label-right">{!! HTML::link('archive/' . $archive->name . '/' . rawurlencode($paper->payment_source), $paper->payment_source) !!}</label></div>
                </div>
            @endif
            <div class="form-group">
